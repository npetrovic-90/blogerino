...
@section('content')
    ...
    style=
    "background-image: url({{ asset('storage/images/bg-img.jpg') }});
     ...
     height: 600px;" >
        <div class="flex text-gray-100 pt-10">
            <div class=" m-auto pt-4 pb-16 sm:m-auto w-4/5 block text-center">
                ...
                <a href="{{ URL('/blog') }}" class=" text-center bg-gray-50 text-gray-700
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        <div>
            <img src="https://pixabay.com/get/gc973a77547db6d2c12c8b3577463c08e698293057ebebc99cdf5535c8065b7eccf9269600eea95c0617adc316e18abdb658b41c86952a59cda90c14980b0295ccb3d60eed86ff2069dbab963f9598a6c_1920.jpg" width="700" alt="">
        </div>
